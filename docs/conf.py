...
git_version = os.environ.get("CI_COMMIT_REF_NAME") or subprocess.check_output(
...
""".format(
    release=release, release_badge=release_badge
)
...
man_pages = [(master_doc, "s1tiling", "S1Tiling Documentation", [author], 1)]
